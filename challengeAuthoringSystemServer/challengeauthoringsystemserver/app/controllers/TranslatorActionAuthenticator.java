...
public class TranslatorActionAuthenticator extends Security.Authenticator {
    private Config configuration;

    @Inject
    public TranslatorActionAuthenticator(WSClient wsChallengeClient, UserService userService) {
    ...
    public String getUsername(Http.Context context){
        ...
        ArrayList<String> rolesList = ControllerUtil.splitSeparatedString(configuration.getString("authorized.translatorRoles"));
        if(rolesList != null) {
