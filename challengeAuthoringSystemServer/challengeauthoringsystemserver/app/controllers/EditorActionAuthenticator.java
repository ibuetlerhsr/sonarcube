...
public class EditorActionAuthenticator extends Security.Authenticator {
    private Config configuration;

    @Inject
    public EditorActionAuthenticator(WSClient wsChallengeClient, UserService userService) {
