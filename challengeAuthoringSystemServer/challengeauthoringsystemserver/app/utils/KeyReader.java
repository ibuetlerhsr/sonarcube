...
public class KeyReader {
    ...
    public static final String PRIVATEPKCS1_BEGIN_MARKER
            = "-----BEGIN RSA PRIVATE KEY"; //$NON-NLS-1$
    public static final String PRIVATEPKCS1_END_MARKER
            = "-----END RSA PRIVATE KEY"; //$NON-NLS-1$

    // Private key file using PKCS #8 encoding
    public static final String PRIVATEPKCS8_BEGIN_MARKER
            = "-----BEGIN PRIVATE KEY"; //$NON-NLS-1$
    public static final String PRIVATEPKCS8_END_MARKER
            = "-----END PRIVATE KEY"; //$NON-NLS-1$

    // Public key file using PKCS #1 encoding
    public static final String PUBLICPKCS1_BEGIN_MARKER
            = "-----BEGIN RSA PUBLIC KEY"; //$NON-NLS-1$
    public static final String PUBLICPKCS1_END_MARKER
            = "-----END RSA PUBLIC KEY"; //$NON-NLS-1$

    // Public key file using PKCS #8 encoding
    public static final String PUBLICPKCS8_BEGIN_MARKER
            = "-----BEGIN PUBLIC KEY"; //$NON-NLS-1$
    public static final String PUBLICPKCS8_END_MARKER
            = "-----END PUBLIC KEY"; //$NON-NLS-1$

    private static Map<String, PrivateKey> privatekeyCache = Collections.synchronizedMap(new HashMap<String, PrivateKey>());
    private static Map<String, PublicKey> publickeyCache = Collections.synchronizedMap(new HashMap<String, PublicKey>());

    protected final String fileName;

    /**
     * Create a PEM key file reader.
     *
    ...
    private RSAPublicKeySpec getRSAPublicKeySpec(byte[] keyBytes) throws IOException  {
    ...
    class Asn1Object {
         ...
         * </ul>
         *
         * @param tag Keyword or Identifier
